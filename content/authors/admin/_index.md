...
social:
  - icon: envelope
    icon_pack: fas
    link: 'isab7070@gmail.com'
  - icon: twitter
    icon_pack: fab
    link: https://twitter.com/isabone
    label: Follow me on Twitter
    display:
      header: true
  - icon: graduation-cap # Alternatively, use `google-scholar` icon from `ai` icon pack
    icon_pack: fas
    link: https://scholar.google.com/citations?hl%253Den%2526user%253DQA4Aib4AAAAJ
  - icon: github
    icon_pack: fab
    link: https://github.com/isahmadbbr
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/ibrahim-said-ahmad-42419775/
